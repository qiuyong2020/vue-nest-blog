...
/**
 * 用于拦截上传文件的装饰器：@Upload() => 根据不同的文件格式，自定义拦截选项
...
/**
 * 拦截图片上传的装饰器：@ImageUpload()
 * @params fileType string 允许通过的文件格式
 * @return @upload(fileType, options) Decorator 拦截器
 */
